...
'These constants represent the different exception cases for the GaugeExceptions arrays (currently only needed for LevelGaugeExceptions)
...
Const FlowGaugeCount As Integer = 10
Const LevelGaugeCount As Integer = 18
...
LevelGaugeNames(7) = "Gauge - Palmerston Lake"
LevelGaugeExceptions(7, RAIN) = True

LevelGaugeNames(8) = "Gauge - Canonto Lake"

LevelGaugeNames(9) = "Gauge - Fall River at outlet Sharbot Lake"
LevelGaugeExceptions(9, STAGE) = True
LevelGaugeExceptions(9, RAIN) = True
LevelGaugeExceptions(9, NO_TEMP) = True

LevelGaugeNames(10) = "Gauge - Fall River at outlet Bennett Lake"
LevelGaugeExceptions(10, SKIP_IT) = True
LevelGaugeNames(11) = "Gauge - Mississippi River at outlet Dalhousie Lake"
LevelGaugeExceptions(11, SKIP_IT) = True

LevelGaugeNames(12) = "Gauge - Lanark"

LevelGaugeNames(13) = "Gauge - Mississippi Lake"
LevelGaugeExceptions(13, AIR_TEMP) = True
LevelGaugeExceptions(13, NO_TEMP) = True

LevelGaugeNames(14) = "Gauge - Carleton Place Dam"
LevelGaugeExceptions(14, NO_TEMP) = True

LevelGaugeNames(15) = "Gauge - Poole Creek at Maple Grove"
...
LevelGaugeNames(17) = "Gauge - Carp River at Richardson"

LevelGaugeNames(18) = "Gauge - Mississippi High Falls"
LevelGaugeExceptions(18, SKIP_IT) = True
